...
public class DragViewLayout extends RelativeLayout {
    ...
    public DragViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        floatLayoutParams = getDefaultFloatLayoutParams();
    }

    public WindowManager getFloatWindowManager() {
        return mWindowManager;
    }

    public WindowManager.LayoutParams getDefaultFloatLayoutParams() {
    ...
    public WindowManager.LayoutParams getFloatLayoutParams() {
        return floatLayoutParams;
    }

    public void setFloatLayoutParams(WindowManager.LayoutParams floatLayoutParams) {
        this.floatLayoutParams = floatLayoutParams;
    }
