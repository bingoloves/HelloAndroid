...
public class FloatViewController {
     ...
     */
    public void initFloatLayout(Context context, @DrawableRes int floatIcon,FloatView.OnFloatViewIconClickListener iconClickListener){
        FloatView floatView = new FloatView(context,floatIcon);
