...
public class LogItem implements Parcelable {
    ...
    public static final ArrayList<String> IGNORED_LOG = new ArrayList<String>() {{
    ...
    public LogItem(String line) throws IllegalStateException, ParseException {
